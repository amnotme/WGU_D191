...
SELECT COUNT(*) FROM detail_table where Title like 'Rugrats Shakespeare' AND category_name like 'Action' --30
SELECT COUNT(*) FROM detail_table where Title like 'Suspects Quills' AND category_name like 'Action' --30
